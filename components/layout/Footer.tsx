...
function HashnodeIcon()  { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2.75 20.5 7.875v8.25L12 21.25 3.5 16.125v-8.25L12 2.75z"/><path d="M12 9v6"/><path d="M9 12h6"/></svg>; }
...
const CONNECT_LINKS = [
  { label: "LinkedIn",  href: "https://www.linkedin.com/in/abhinavchaurasia-dev/", icon: <LinkedinIcon />  },
  { label: "GitHub",    href: "https://github.com/abhinavchaurasia-dev",           icon: <GithubIcon />    },
  { label: "Twitter",   href: "https://x.com/abhinavc_dev",                        icon: <TwitterIcon />   },
  { label: "YouTube",   href: "https://www.youtube.com/@AbhinavChaurasia22",       icon: <YouTubeIcon />   },
  { label: "Instagram", href: "https://www.instagram.com/abhinavc_dev/",           icon: <InstagramIcon /> },
  { label: "Medium",    href: "https://medium.com/@abhinavchaurasia-dev",          icon: <MediumIcon />    },
  { label: "Hashnode",  href: "https://hashnode.com/@abhinavchaurasia-dev",        icon: <HashnodeIcon />  },
