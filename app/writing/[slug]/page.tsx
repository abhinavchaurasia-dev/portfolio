...
const SOCIALS = [
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@abhinavchaurasia-dev",
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/abhinavc_dev",
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Pinterest",
    href: "https://pinterest.com/abhinavc_dev",
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Medium",
    href: "https://medium.com/@abhinavc_dev",
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
