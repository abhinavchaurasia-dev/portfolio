...
/* ============================================================
   NOW PLAYING API (disabled mode)

   Spotify/Redis live tracking is intentionally disabled.
   Keep this route as a valid module so Next.js build type checks pass.
   ============================================================ */
...
/* ============================================================
   PRESERVED FULL IMPLEMENTATION (for future re-enable)

   This is the previous complete route implementation, kept here
   verbatim as comments so it can be re-enabled quickly later.
   ============================================================ */
